#
#  Be sure to run `pod spec lint WXSequenceView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "罗凇" => "523720512@qq.com" }
  # Or just: s.author    = "罗凇"
  # s.authors            = { "罗凇" => "523720512@qq.com" }
  # s.social_media_url   = "http://twitter.com/罗凇"
  ...
  s.source       = { :git => "https://github.com/kiss7xin/WXSequenceView.git", :tag => "#{s.version}" }
